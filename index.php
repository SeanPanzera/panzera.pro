...
<html lang="en" class="home">
  <head>
    ...
    <?php
      ...
      $i = rand(1,$filecount); // generate random number size of the number of bgs
    ?>
    <style type="text/css">
    <!--
      body{
